...
ASTRALE_VERSION=0.4.0-alpha.8 curl -fsSL https://raw.githubusercontent.com/astrale-os/cli/main/install.sh | sh
...
Use `--channel canary` to move channels or `--version 0.4.0-alpha.8` to install
an exact release.
