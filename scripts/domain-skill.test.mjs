...
test('the shipped Domain skill teaches the current SDK authoring boundary', () => {
  ...
  const implementing = readFileSync(join(root, 'references', 'runtime.md'), 'utf8')
  const integrations = readFileSync(join(root, 'references', 'integrations.md'), 'utf8')
  const modeling = readFileSync(join(root, 'references', 'schema.md'), 'utf8')
  ...
  const security = readFileSync(join(root, 'references', 'policies.md'), 'utf8')
  const simulating = readFileSync(join(root, 'references', 'testing.md'), 'utf8')
