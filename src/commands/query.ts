...
export default {
  ...
  afterHelpText: [
    ...
    '',
    '  --ast accepts a raw QueryASTInput JSON object for the full v1 AST language.',
    '  The CLI only checks that it is a JSON object; the kernel-client parser owns',
    '  schema validation. @self is not expanded inside --ast JSON.',
    '',
  ...
  options: [
    ...
    { flags: '--ast <json>', description: 'Raw QueryASTInput JSON object' },
